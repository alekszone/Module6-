...
router.get("/", async(req, res)=>{
    ...
    let query = 'SELECT * FROM "student"' //create my query
...
router.get("/:id", async (req, res)=>{
    const response = await db.query('SELECT id, name, surname, email, dateOfBirth FROM "student" WHERE id = $1', 
                                                                                        [ req.params.asin ])
...
router.post("/", async (req, res)=> {
    const response = await db.query(`INSERT INTO "student" (id, name, surname, email, dateOfBirth) 
                                     Values ($1, $2, $3, $4, $5)
                                     RETURNING *`, 
...
router.delete("/:id", async (req, res) => {
    const response = await db.query(`DELETE FROM "student" WHERE id = $1`, [ req.params.id ])
